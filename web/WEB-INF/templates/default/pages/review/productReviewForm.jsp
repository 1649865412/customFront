  ...
  -->
		...
		<form role="form" method="post" action="#" id="productReviewForm">
				<div class="form-group">
                      <label for="inputFirstName" class="control-label">为您设计的产品添加说明</label>
                  </div>
                  <div class="form-group">
                      <label for="inputFirstName" class="control-label">您的昵称:<span class="text-error">*</span></label>
                      <div>
                          <input readonly="readonly" name="customerName" id="productReview_username" type="text" class="form-control" size="40" value="${appUser.appuserId==-2?'':(empty appUser.firstname?appUser.username:appUser.firstname)}"/>
                      </div>
                  </div>
                  <div class="form-group">
                      <label for="input_title" class="control-label">您的设计品标题:<span class="text-error">*</span></label>
                      <div>
                  ...
                  <div class="form-group">
                  	    <label for="input_comment" class="control-label">您的设计品内容:<span class="text-error">*</span></label>
                  ...
                  <%--<div class="form-group">
           		...
           		<input type="button" class="btn-default-1" value="提交说明" onclick="doReviewAction(this.form,${appConfig.isAllowAnonymousReview})" >
