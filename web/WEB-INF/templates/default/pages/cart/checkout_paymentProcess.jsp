...
<div class="maincontent" id="designer_main">
     ...
     <div class="chart_bottom" style="width:990px; margin:auto;">
	              ...
	              <div class="control-group">
	                <div class="controls">
	                	<c:forEach items="${shippingAddressList}" var="address" varStatus="status">
		                	<label  for="radios-${address.id }" id="current_address_${address.id }">
       ...
       <div class="checkout_info">
         ...
         <table class="checkout_table" cellspacing="0" cellpadding="0">
           ...
           <tfoot>
           	<tr>
            	<td colspan="7">
                	<table width="300" border="0" cellspacing="0" cellpadding="0" align="right" style="margin-top:10px;">
                          <tr>
                            <td class="checkout_howmany" rowspan="4" valign="top">共计有<span class="colour_trash padding_td text_bold">${shoppingcart.buyNowItemsCount }</span>件商品</td>
                         ...
                         <tr>
                          ...
                          <tr class="chart_last_total">
                            <td class="colour_trash text_bold">共：</td>
    ...
    <div>
     ...
     <label  for="radios-{0}" id="current_address_{0}">
